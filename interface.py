...
class Table_window(Tk):
    ...
    def render_operation_table(self):
        ...
        self.table.column("Op_Reduce", anchor=CENTER, width=120)
        self.table.column("Bytes_send",anchor=CENTER,width=130)
        self.table.column("Bytes_recv",anchor=CENTER,width=130)
        self.table.column("Required_level", anchor=CENTER, width=130)
        self.table.column("Provided_level", anchor=CENTER, width=130)
        ...
        self.table.heading("Op_Reduce", text="Op Reduces", anchor=CENTER)
